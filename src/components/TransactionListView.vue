		...
		<div class="row">
			<div class="col-xs-12">
				<table class="table table-hover table-striped">
					...
					<tbody>
						<h5 v-show="transactions.length == 0">No new transactions created us today!</h5>
	...
	export default {
		...
		route: {
			data({
				...
				let getTransactions = (to.fullPath === "/transactions"? store.getTransactions: store.getNewTransactions)

				return getTransactions(to.params.id).then(function (data) {
